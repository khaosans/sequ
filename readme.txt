...
This is part of my CS300 class at Portland State University with Proffessor Massey.  
...
To run the test:
1) copy both files (sequ.py and tests.py) to the working directory
2) run the program tests.py by typing in "python tests.py"
3) read the output to ensure that the values are as expected

To add more tests cases:
1) open the tests.py file and add new test cases
